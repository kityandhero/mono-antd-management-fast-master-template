...
class BaseInnerPageList extends InnerMultiPage {
  ...
  goToEdit = (record) => {
    ...
    this.goToPath(`/tag/edit/load/${id}/key/basicInfo`);
  };
    ...
    return [
      {
        ...
        hidden: !checkHasAuthority(
          accessWayCollection.tag.addBasicInfo.permission,
        ),
      ...
      items: [
        {
          ...
          text: '设置基本信息',
          hidden: !checkHasAuthority(
            accessWayCollection.tag.updateBasicInfo.permission,
          ),
        },
        {
        ...
        },
        {
          ...
          text: '设置排序值',
          hidden: !checkHasAuthority(
            accessWayCollection.tag.updateSort.permission,
          ),
        },
        {
          type: dropdownExpandItemType.divider,
        },
        {
          ...
          text: `设置图片`,
          hidden: !checkHasAuthority(
            accessWayCollection.tag.updateImage.permission,
          ),
        },
        {
          type: dropdownExpandItemType.divider,
