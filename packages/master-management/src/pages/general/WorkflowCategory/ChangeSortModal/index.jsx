...
const visibleFlag = 'c2698146e23842bba4295e58ee08b117';
...
class ChangeSortModal extends BaseUpdateModal {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      submitApiPath: modelTypeCollection.workflowCategoryTypeCollection.setSort,
    };
  }
  ...
  supplementLoadRequestParams = (o) => {
    ...
    const { workflowCategoryId } = externalData;
