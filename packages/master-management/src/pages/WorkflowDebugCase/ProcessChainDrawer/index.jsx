...
const visibleFlag = 'f27d282ab0934cec8189839610d983ba';

@connect(({ workflowDebugCase, schedulingControl }) => ({
  workflowDebugCase,
  schedulingControl,
}))
class ProcessChainDrawer extends BaseVerticalFlexDrawer {
  static open() {
  ...
  doOtherAfterLoadSuccess = ({
    ...
    const listChainAll = getValueByKey({
      data: metaData,
      key: fieldData.listChainAll.name,
      convert: convertCollection.array,
    });

    const treeChainAll = getValueByKey({
      data: metaData,
      key: fieldData.treeChainAll.name,
    });
    ...
    const treeChainApprove = getValueByKey({
      data: metaData,
      key: fieldData.treeChainApprove.name,
    });
