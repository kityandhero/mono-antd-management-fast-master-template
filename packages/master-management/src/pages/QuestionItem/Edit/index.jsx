...
class Edit extends DataTabContainerSupplement {
  ...
  constructor(properties) {
    ...
    this.state = {
      ...
      backPath: `/questionItem/pageList/key`,
      questionItemId: null,
    };
  }
      ...
      buttons: [
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.questionItem.setOnline.permission,
          ),
        ...
        },
        {
          ...
          hidden: !checkHasAuthority(
            accessWayCollection.questionItem.setOffline.permission,
          ),
  ...
  establishPageHeaderContentGridConfig = () => {
    ...
    return [
      {
        label: fieldData.questionItemId.label,
        value: getValueByKey({
          data: metaData,
