...
import {
  ...
  updateBasicInfoData,
  updateSortData,
} from '../../services/positionBase';

export const positionBaseTypeCollection = {
  pageList: 'positionBase/pageList',
  singleList: 'positionBase/singleList',
  get: 'positionBase/get',
  addBasicInfo: 'positionBase/addBasicInfo',
  updateBasicInfo: 'positionBase/updateBasicInfo',
  updateSort: 'positionBase/updateSort',
  refreshCache: 'positionBase/refreshCache',
  pageListOperateLog: 'positionBase/pageListOperateLog',
};

export function buildModel() {
  return {
    namespace: 'positionBase',
